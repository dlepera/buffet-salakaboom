...
class LogRegistro extends Principal{
    ...
    protected $log_registro_tabela, $log_registro_idreg, $log_registro_data_criacao,
        ...
        $log_registro_usuario_alteracao, $log_registro_usuario_exclusao;
    ...
    public function _salvar($remover = false, $salvar=true){
        ...
        if( is_null($this->log_registro_data_criacao) || $this->log_registro_data_criacao == '0000-00-00 00:00:00' ):
            ...
            $query = "INSERT INTO ". $this->_bd_tabela() ." ("
                    . " log_registro_usuario_criacao, log_registro_data_criacao, log_registro_idreg, log_registro_tabela) VALUES ("
                    . " {$this->log_registro_usuario_criacao}, '{$this->log_registro_data_criacao}', {$this->log_registro_idreg}, '{$this->log_registro_tabela}')";
        else:
            if( !$remover ):
