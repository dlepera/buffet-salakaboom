	...
	public function _fazerlogin($usuario='', $senha=''){
		...
		if( $usuario == $this->root_usuario && $senha == $this->root_senha ):
			...
			$lis_u = end($mod_u->_listar(
                "U.usuario_info_login = '{$usuario}' AND U.usuario_info_senha = '{$senha}'", null,
                'U.usuario_id, U.usuario_info_grupo, G.grupo_usuario_descr, U.usuario_info_nome, U.usuario_info_email, U.usuario_info_telefone,'
            ...
            $lis_pu = $mod_pu->_listar(
                "permissao_usuario = {$lis_u['usuario_id']}",
                null,
                "CONCAT('modulo_', permissao_modulo) AS modulo,"
